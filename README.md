...
> Or are you like me that projects generated by conventional tooling are lacking in multiple regards and still need a lot of stup and broilerplate to get them to a suitable state?
...
- **Variable transformations:** zappy allows you to transform provided variable values to different castings (camel case, kebab case, etc.)
